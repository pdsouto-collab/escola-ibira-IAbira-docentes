...
import { ArrowLeft, Edit3, Trash2, Plus, Check, X, Loader2 } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#f2efe9] font-sans">
      ...
      <div className="w-64 bg-[#4a5d4e] text-white flex flex-col p-6 shadow-xl z-10">
        <div className="mb-10 font-bold text-xl tracking-tight text-[#e8a375]">
          Escola Ibirá
          <span className="block text-sm font-normal text-[#8fb39c]">Configurações Gerais</span>
        </div>
        <nav className="flex flex-col gap-2">
          <div 
            className="p-3 hover:bg-[#394a3d] rounded-lg text-sm cursor-pointer opacity-70 flex items-center gap-2"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b p-4 flex justify-between items-center shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-[#2A4B3A]">Configurações de Sub-categorias</h1>
          </div>
          <Button 
            className="bg-[#4a5d4e] hover:bg-[#394a3d] text-white" 
            onClick={() => window.location.href = '/diretoria'}
          >
            Voltar ao Painel da Diretoria
          </Button>
        </header>
